...
| **INT1-A**    | Interrupt | Accelerometer and gyroscope interrupt 2 signal                        |
...
| **CS-M**    | Chip Select	 | SPI enable, I2C/SPI mode selection for magnetometer                       |
| **CS-A**    | Chip Select	 | SPI enable, I2C/SPI mode selection for accelerometer and gyroscope                       |
| **SDO-M**    | Data Output	 | SPI serial data output (SDO) for magnetometer, I2C address bit (SA0) for magnetometer  |
| **SDO-A**    | Data Output	 |   SPI serial data output (SDO) for accelerometer and gyroscope, I2C address bit (SA0) for A/G |
...
| **JP3** | **NC** | **Address jumper**(*More below) that alows swaping between 2 addresses. |
...
| **JP6** | **NC**   |When connected, the **voltage regulator is powered by 5V**, stepping it down to **3. |

---
## Address jumper

As mention before the **JP3** is a **address jumper** for the **I2C address** that when left **open** has the address of **0x6A** , while when closed its address changes to **0x6B**.
